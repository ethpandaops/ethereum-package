...
def launch(
    ...
    network = (
        network if network in constants.PUBLIC_NETWORKS else constants.GENESIS_CONFIG_MOUNT_PATH_ON_CONTAINER + "/config.yaml"
    )
    ...
    config_file_path = shared_utils.path_join(
        CB_CONFIG_MOUNT_DIRPATH_ON_SERVICE,
        CB_CONFIG_FILENAME,
    )

...
mev_boost_context_module = import_module("github.com/barnabasbusa/eth2-package/src/mev_boost/mev_boost_context.star")
...
def get_config(mev_boost_launcher, network_id):
	...
	return ServiceConfig(
		...
		env_vars = {
			...
			# This is set to match this file https://github.com/barnabasbusa/eth-network-package/blob/main/static_files/genesis-generation-config/cl/config.yaml.tmpl#L11

...
def launch_apache(
    ...
    config_files_artifact_name = plan.upload_files(
        src = static_files.APACHE_CONFIG_FILEPATH,
        name = "apache-config",
    )
    ...
    template_and_data_by_rel_dest_filepath[APACHE_ENR_LIST_FILENAME] = enr_list_template_and_data
    template_and_data_by_rel_dest_filepath[APACHE_ENODE_FILENAME] = enode_template_and_data

...
# The min/max CPU/memory that the execution node can see
...
VERBOSITY_LEVELS = {
    ...
    constants.GLOBAL_LOG_LEVEL.want: "2",
...
def launch(
    ...
    metric_info = node_metrics.new_node_metrics_info(

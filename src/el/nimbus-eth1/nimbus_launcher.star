...
def get_config(
    ...
    if persistent:
        ...
        files[EXECUTION_DATA_DIRPATH_ON_CLIENT_CONTAINER] = Directory(
            ...
            size = int(participant.el_volume_size) if int(participant.el_volume_size) > 0 else constants.VOLUME_SIZE[volume_size_key][constants.EL_TYPE.nimbus + "_volume_size"],
        )

...
def launch_nginx(
    ...
    config_files_artifact_name = plan.upload_files(
        src = static_files.NGINX_CONFIG_FILEPATH,
        name = "nginx-config",
    )
    ...
    template_and_data_by_rel_dest_filepath[NGINX_ENR_LIST_FILENAME] = enr_list_template_and_data
    template_and_data_by_rel_dest_filepath[NGINX_ENODE_FILENAME] = enode_template_and_data

    bootstrap_info_files_artifact_name = plan.render_templates(
        template_and_data_by_rel_dest_filepath,
        "nginx-bootstrap-info",
    )

...
def new_env_file_for_el_cl_genesis_data(
    ...
    return {
        ...
        "FuluMaxBlobsPerTx": network_params.fulu_max_blobs_per_tx if network_params.fulu_max_blobs_per_tx > 0 else 0,
        ...
        "Bpo1MaxBlobsPerTx": network_params.bpo_1_max_blobs_per_tx if network_params.bpo_1_max_blobs_per_tx > 0 else 0,
        ...
        "Bpo2MaxBlobsPerTx": network_params.bpo_2_max_blobs_per_tx if network_params.bpo_2_max_blobs_per_tx > 0 else 0,
        ...
        "Bpo3MaxBlobsPerTx": network_params.bpo_3_max_blobs_per_tx if network_params.bpo_3_max_blobs_per_tx > 0 else 0,
        ...
        "Bpo4MaxBlobsPerTx": network_params.bpo_4_max_blobs_per_tx if network_params.bpo_4_max_blobs_per_tx > 0 else 0,
        ...
        "Bpo5MaxBlobsPerTx": network_params.bpo_5_max_blobs_per_tx if network_params.bpo_5_max_blobs_per_tx > 0 else 0,

...
def new_env_file_for_el_cl_genesis_data(
    ...
    return {
        ...
        "ProposerReorgCutoffBps": network_params.proposer_reorg_cutoff_bps,
        "AttestationDueBps": network_params.attestation_due_bps,
        "AggregateDueBps": network_params.aggregate_due_bps,
        "SyncMessageDueBps": network_params.sync_message_due_bps,
        "ContributionDueBps": network_params.contribution_due_bps,

...
def get_api_config(
    ...
    return ServiceConfig(
        ...
        env_vars = {
            ...
            "NETWORK_NAME": network_name if network_name in constants.PUBLIC_NETWORKS else "devnet",
        },
...
def get_web_config(
    ...
    return ServiceConfig(
        ...
        env_vars = {
            "DATABASE_URL": postgres_url,
            "DIRECT_URL": postgres_url,
            "NEXT_PUBLIC_NETWORK_NAME": network_name if network_name in constants.PUBLIC_NETWORKS else "devnet",
            "SECRET_KEY": SECRET_KEY,
            "POSTGRES_STORAGE_ENABLED": "true",
        },
        min_cpu = WEB_MIN_CPU,

...
def get_grafana_config_dir_artifact_uuid(
    ...
    grafana_dashboards_artifacts_name = plan.upload_files(
        static_files.GRAFANA_DASHBOARDS_CONFIG_DIRPATH,
...
def merge_dashboards_artifacts(
    ...
    for additional_dashboard_data in grafana_additional_dashboards_data:
        files[additional_dashboard_data[GRAFANA_ADDITIONAL_DASHBOARDS_SERVICE_PATH_KEY]] = additional_dashboard_data[GRANAFA_ADDITIONAL_DASHBOARDS_ARTIFACT_NAME_KEY]

...
ETHEREUM_GENESIS_GENERATOR = struct(
    ...
    verkle_support_genesis="ethpandaops/ethereum-genesis-generator:kaustinen-with-shapella",  # soon to be deneb genesis
    verkle_genesis="ethpandaops/ethereum-genesis-generator:kaustinen-with-shapella",
)

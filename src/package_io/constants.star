...
ETHEREUM_GENESIS_GENERATOR = struct(
    ...
    verkle_support_genesis="ethpandaops/ethereum-genesis-generator:verkle-gen-v1.0.10",  # soon to be deneb genesis
    verkle_genesis="ethpandaops/ethereum-genesis-generator:verkle-gen-v1.0.10",
)

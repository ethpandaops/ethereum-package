...
def shadowfork_prep(
    ...
    if constants.NETWORK_NAME.ephemery in base_network:
        ...
        network_id = constants.NETWORK_ID[base_network]  # overload the network id to match the network name
            ...
            config = ServiceConfig(
                ...
                files = {
                    ...
                    "/execution-data": Directory(
                        ...
                        size = constants.VOLUME_SIZE[base_network][el_type + "_volume_size"],
                    ),

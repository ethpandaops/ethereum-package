...
network_params:
  ...
  # Maximum number of blobs per block for BPO2
  # If only max is set, target is auto-calculated as 2/3 of max
  # If only target is set, max is auto-calculated as 3/2 of target
  bpo_2_max_blobs: 12
  # Target number of blobs per block for BPO2
  ...
  # Maximum number of blobs per block for BPO3
  # If only max is set, target is auto-calculated as 2/3 of max
  # If only target is set, max is auto-calculated as 3/2 of target
  bpo_3_max_blobs: 12
  # Target number of blobs per block for BPO3
  ...
  # Maximum number of blobs per block for BPO4
  # If only max is set, target is auto-calculated as 2/3 of max
  # If only target is set, max is auto-calculated as 3/2 of target
  bpo_4_max_blobs: 12
  # Target number of blobs per block for BPO4
  ...
  # Maximum number of blobs per block for BPO5
  # If only max is set, target is auto-calculated as 2/3 of max
  # If only target is set, max is auto-calculated as 3/2 of target
  bpo_5_max_blobs: 12
  # Target number of blobs per block for BPO5

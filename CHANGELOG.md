...
## [6.2.0](https://github.com/ethpandaops/ethereum-package/compare/6.1.0...6.2.0) (2026-09-08)
...
* add gas_limit_schedule (EIP-8261 GPO) network param ([#1472](https://github.com/ethpandaops/ethereum-package/issues/1472)) ([36d7d74](https://github.com/ethpandaops/ethereum-package/commit/36d7d74fff9b952481a1fcb71271bd4b14e931e2))
...
* auto-enable FRAMES_ENABLED when a participant image tag contains 'frame' ([#1475](https://github.com/ethpandaops/ethereum-package/issues/1475)) ([a19d4e6](https://github.com/ethpandaops/ethereum-package/commit/a19d4e6ae34401aceb7350866704c189012ce2ec))
...
* **consensoor:** define QUIC discovery port and pass --quic-port ([#1464](https://github.com/ethpandaops/ethereum-package/issues/1464)) ([7b3e58b](https://github.com/ethpandaops/ethereum-package/commit/7b3e58bdff75c1cbd445411e9412e4aa9f025d0a))
...
* default EL clients to snap sync when checkpoint sync is enabled ([#1465](https://github.com/ethpandaops/ethereum-package/issues/1465)) ([0ffa708](https://github.com/ethpandaops/ethereum-package/commit/0ffa708650dbd90b5cdce9b238ac64183af482a9))
...
* **el:** default execution clients to discv5-only with ENR bootnodes ([#1461](https://github.com/ethpandaops/ethereum-package/issues/1461)) ([8e81c57](https://github.com/ethpandaops/ethereum-package/commit/8e81c5709deffad01d0bd1770d259c224f1ed349))
* enable ens resolver in dora ([#1448](https://github.com/ethpandaops/ethereum-package/issues/1448)) ([feb0d37](https://github.com/ethpandaops/ethereum-package/commit/feb0d37126690e1c080e85ca666564c20f1ad225))
...
* set payload_due_bps default to 5000 for glamsterdam-devnet-7 ([#1443](https://github.com/ethpandaops/ethereum-package/issues/1443)) ([d5dc641](https://github.com/ethpandaops/ethereum-package/commit/d5dc64193080f3ff62332885b038365ff9230c0d))
...
* **spamoor:** support auto-starting built-in default spammers ([#1445](https://github.com/ethpandaops/ethereum-package/issues/1445)) ([73ce22c](https://github.com/ethpandaops/ethereum-package/commit/73ce22cac6792f1217a2bee65a7e52175ff7dde7))
...
* update default BPO blob schedule values ([#1468](https://github.com/ethpandaops/ethereum-package/issues/1468)) ([c40d4fb](https://github.com/ethpandaops/ethereum-package/commit/c40d4fb40bf3ac8fb3ac71695dbc51078a53f1b7))
* update zkboost usage to v0.9.0 ([#1450](https://github.com/ethpandaops/ethereum-package/issues/1450)) ([39bdd0d](https://github.com/ethpandaops/ethereum-package/commit/39bdd0d78c3b094ddaa4f5c580062dfdf1e098c6))
* use genesis.json for besu and nethermind ([#1466](https://github.com/ethpandaops/ethereum-package/issues/1466)) ([199620b](https://github.com/ethpandaops/ethereum-package/commit/199620b24ac979c676010c5a68b2893c2bce4f1f))
...
* allocate mev_type buildoor key after genesis-registered builders ([#1480](https://github.com/ethpandaops/ethereum-package/issues/1480)) ([5ec41d4](https://github.com/ethpandaops/ethereum-package/commit/5ec41d44ae23fb01b036c11b25d98547cc9c3be4))
* apply log level to the prysm validator client ([#1454](https://github.com/ethpandaops/ethereum-package/issues/1454)) ([e88e1ca](https://github.com/ethpandaops/ethereum-package/commit/e88e1caf7f04655d23e46f43dd1f12b2a3f9ec2b))
...
* bump ethereum-genesis-generator to 6.2.1 ([#1479](https://github.com/ethpandaops/ethereum-package/issues/1479)) ([d3eb8c6](https://github.com/ethpandaops/ethereum-package/commit/d3eb8c64f715382736396b733d68718de62fef5c))
...
* default to count1 for buildoor instances ([#1449](https://github.com/ethpandaops/ethereum-package/issues/1449)) ([1fabda4](https://github.com/ethpandaops/ethereum-package/commit/1fabda451b36c1448a590bc5965877e1f1daa4c6))
* derive builder keys past the preregistered validator range ([#1470](https://github.com/ethpandaops/ethereum-package/issues/1470)) ([e40cae5](https://github.com/ethpandaops/ethereum-package/commit/e40cae59ce64825e02de6b2040db9681cbf592ef))
...
* emit caplin bootnode override and enable local discovery ([#1452](https://github.com/ethpandaops/ethereum-package/issues/1452)) ([6031164](https://github.com/ethpandaops/ethereum-package/commit/603116472f043ab42b7dd609b1613236c2f0cb03))
* Enable buildoor for Nimbus ([#1476](https://github.com/ethpandaops/ethereum-package/issues/1476)) ([0350d2e](https://github.com/ethpandaops/ethereum-package/commit/0350d2e98735ff395b088fe8c261f0c9bb652c8a))
...
* **prysm:** honor explicit Beacon API flag for Prysm BN + REST VC ([#1471](https://github.com/ethpandaops/ethereum-package/issues/1471)) ([04988b4](https://github.com/ethpandaops/ethereum-package/commit/04988b4d121eec11d930086c899a19768f06f452))
* **prysm:** keep the VC on gRPC when paired with a Prysm beacon node ([#1456](https://github.com/ethpandaops/ethereum-package/issues/1456)) ([b5b3af6](https://github.com/ethpandaops/ethereum-package/commit/b5b3af65248f11702216e377d0377bcd8ccf4caf))
...
* **shadowfork:** count delivered snapshot bytes with curl -w instead of a FIFO ([#1487](https://github.com/ethpandaops/ethereum-package/issues/1487)) ([c0db06b](https://github.com/ethpandaops/ethereum-package/commit/c0db06b29b8266e65c9b80b64895e07058d28d0b))
* **shadowfork:** resume snapshot downloads by byte offset ([#1486](https://github.com/ethpandaops/ethereum-package/issues/1486)) ([5648596](https://github.com/ethpandaops/ethereum-package/commit/5648596dca98442b7d0cf9b8eead31da8e6b7494))
...
* restore tx_fuzz ([#1463](https://github.com/ethpandaops/ethereum-package/issues/1463)) ([27a33b9](https://github.com/ethpandaops/ethereum-package/commit/27a33b90d159de24eb05f8ff27b8ddf0beb813d5))
